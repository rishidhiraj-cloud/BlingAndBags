...
function updateMonthTotals(entries) {
    const totals = entries.reduce((acc, e) => {
        ...
        acc.cash += parseFloat(e.saving_cash || 0) || 0;
        return acc;
        ...
        return `
            <div class="history-item">
                ...
                <div class="history-details">
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Saving Cash:</span>
                        <span class="detail-value">₹${formatIndianNumber(entry.saving_cash || 0)}</span>
                    </div>
                    <div class="detail-item">
...
Saving Cash: ₹${formatIndianNumber(entry.saving_cash || 0)}
